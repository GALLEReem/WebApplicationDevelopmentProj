...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title  -->
        <title>Reem Gallery Art | Confirm Order</title>
                            ...
                            <div class="checkout_details_area mt-50 clearfix">
                                <%  
                                    ...
                                    for (int i = 0; i < addCart.size(); i++) {
                                       st.executeUpdate("INSERT into jdbcex.orderdetails (ProductId,UserID,totalprice)  "
                                            + "VALUES ('" + addCart.get(i).getIDproduct() + "', '" + u.getEmail() + "','" + totalprice + "')");
                                    }
                                %>
                                <div class="cart-title">
                                    <h2>Thanks for your order  <a href="index.jsp"> Back Home</a></h2>
                                </div>
