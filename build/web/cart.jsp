                                ...
                                <table class="table table-responsive">
                                    ...
                                    <%
                                        ...
                                        if (session.getAttribute("cart") != null) {
                                            ArrayList<Cart> addC = (ArrayList<Cart>) session.getAttribute("cart");
                                            for (int i = 0; i < addC.size(); i++) {
                                                
                                                int quantity = addC.get(i).getQuantity();
                                                if (quantity > 0) {
                                                    totalPrice = totalPrice + (Integer.parseInt(addC.get(i).getPrice())) * quantity;

                                    %>
                                    <tbody>
                                        <tr>
                                            <td class="cart_product_img">
                                                <a href="#"><img  src="ProductPictures/<% out.println(addC.get(i).getPicture()); %>"alt="Product"></a>
                                            </td>
                                            <td class="cart_product_desc">
                                                <h5><% out.println(addC.get(i).getTitle()); %></h5>
                                            </td>
                                            <td class="price">
                                                <span>$<% out.println(addC.get(i).getPrice());%></span>
                                            </td>
                                            <td class="qty">
                                                <div class="qty-btn d-flex">
                                                    ...
                                                    <input type="number" style="
                                                           width: 40%;
                                                           padding: 0px 9px;
                                                           "id="qty" name="qty"  min="0" value="<%=quantity%>">
                                                    <script>
                                                        function getquantity() {
                                                            var qty=document.getElementById("qty").value;
                                                            var IDproduct=<% out.println(addC.get(i).getIDproduct());%>;
                                                            document.location.href ="UpdateQuantity.jsp?id="+IDproduct+"&quantity="+qty;
                                                        }
                                                    </script>
                                                    <a class="btnref" onclick="getquantity()" ><i class="fa fa-refresh"></i></a></td>
                                            </div>
                                            </td>
                                        </tr>
                                    </tbody>
                                    ...
                                    %>
                                    <h4>No items in your cart Please add something</h4>
                                    <%
                                        }
                                    %>
                                </table>
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="cart-summary">
                                ...
                                <ul class="summary-table">
                                    ...
                                    <li><span>total:</span> <span>$<% out.println(totalPrice);%></span></li>
                                </ul>
                                <%                    if (session.getAttribute("user") != null) {

                %>
                                <div class="cart-btn mt-100">
                                    <a href="checkout.jsp?totalprice=<% out.println(totalPrice);%>" style="background-color:#e60073 " class="btn amado-btn w-100">Checkout</a>
                                </div>
                                 <%                            }else{
%>Please Login first
                                <%
