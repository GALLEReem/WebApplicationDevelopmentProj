...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
    	...
    	<div class="amado-btn-group mt-30 mb-100">
                <a href="./Register.html" class="btn amado-btn mb-15">Register</a>
                <a href="./Login.html" class="btn amado-btn active">Login</a>
            </div>
            <!-- Cart Menu -->
                                ...
                                <tbody>
									...
									<td class="cart_product_img">
                                        ...
                                        <td class="cart_product_desc">
                                            <h5>- White Modern Chair</h5> <h5>- sds dsds Chair</h5><h5>- sds dsds Chair</h5>
                                        </td>
                                        <td class="price">
                                            <span>$130</span>
                                        </td>
